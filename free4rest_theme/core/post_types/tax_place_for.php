<?php
if ( ! function_exists( 'bgt_cat_place_for' ) ) {

// Register Custom Taxonomy
function bgt_cat_place_for() {

	$labels = array(
		'name'                       => _x( 'Place for', 'Place for', 'free4rest' ),
		'singular_name'              => _x( 'Place for', 'Place for', 'free4rest' ),
		'menu_name'                  => __( 'Place for', 'free4rest' ),
	...
	register_taxonomy( 'cat_place_for', array( 'place' ), $args );

}
add_action( 'init', 'bgt_cat_place_for', 0 );
