<?php
if ( ! function_exists( 'bgt_cat_activity' ) ) {

// Register Custom Taxonomy
function bgt_cat_activity() {

	$labels = array(
		'name'                       => _x( 'Activities', 'Activities', 'free4rest' ),
		'singular_name'              => _x( 'Activities', 'Activities', 'free4rest' ),
		'menu_name'                  => __( 'Activities', 'free4rest' ),
	...
	register_taxonomy( 'cat_activity', array( 'place' ), $args );

}
add_action( 'init', 'bgt_cat_activity', 0 );
