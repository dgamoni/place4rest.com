...
if ( ! function_exists('bgt_cpt_parking') ) {

// Register Custom Post Type
function bgt_cpt_parking() {

	$labels = array(
		'name'                  => _x( 'Parking', 'Parking', 'free4rest' ),
		'singular_name'         => _x( 'Parking', 'Parking', 'free4rest' ),
		'menu_name'             => __( 'Parking', 'free4rest' ),
		'name_admin_bar'        => __( 'Parking', 'free4rest' ),
	...
	$args = array(
		'label'                 => __( 'Parking', 'free4rest' ),
		'description'           => __( 'Parking', 'free4rest' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'custom-fields', 'page-attributes', 'excerpt', 'comments' ),
		'taxonomies'            => array( 'cat_parking', 'cat_services' ),
		'hierarchical'          => false,
		'public'                => true,
		'show_ui'               => true,
		'show_in_menu'          => true,
...
add_action( 'init', 'bgt_cpt_parking', 0 );
